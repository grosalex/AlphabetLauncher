 ...
 */
class AppModelSectionMapAdapter(var items: AppModelSectionMap, val recycledViewPool: RecyclerView.RecycledViewPool) : RecyclerView.Adapter<AppModelSectionViewHolder>() {
